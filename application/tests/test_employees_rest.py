...
class TestEmployeesRest(unittest.TestCase):
    ...
    def test_post_employees(self):
        ...
        tester = app.test_client(self)
        response = tester.post("/api/employees", json={"name": "Test Test",
                                                       "birth_date": "1111-12-22",
    ...
    def test_put_employee(self):
        ...
        response = tester.put(f"/api/employee/{mock_emp.id}", json={"name": "Test Test",
                                                                    "birth_date": "1111-12-22",
                                                                    "department": "Test department",
                                                                    "salary": 12345})
    ...
    def test_delete_employee(self):
        """This test is for getting correct response
        from /api/employee/id DELETE request"""
        tester = app.test_client(self)
